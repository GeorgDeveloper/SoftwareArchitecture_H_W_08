...
public class BookingPresenter implements ViewObserver {
    ...
    @Override
    public void updateReservationTable(int reservationNo, Date date, int tableNo, String name) {

        try {
            int reservationNewNo = model.changeReservationTable(reservationNo, date, tableNo, name);
